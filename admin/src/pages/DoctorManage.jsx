...
const DoctorManage = ({ token }) => {
    ...
    return (
        <div>
            ...
            <form onSubmit={onSubmitHandler} className={`w-full mb-10 ${visible === 'false' ? 'hidden' : ''}`}>
                <div className='flex'>
                    <div className='flex flex-col w-2/3 items-start gap-3'>
                        ...
                        {/* <div className=''>
                            <p className='mb-2'>Workday</p>
                            <div className='flex flex-col gap-2 ml-8'>
                                <p>Morning:</p>
                                <div className='flex gap-3'>
                                    <div onClick={() => setWorkDay(prev => prev.includes("11") ? prev.filter(item => item !== "11") : [...prev, "11"])}>
                                        <p className={`${workDay.includes("11") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T2</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("12") ? prev.filter(item => item !== "12") : [...prev, "12"])}>
                                        <p className={`${workDay.includes("12") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T3</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("13") ? prev.filter(item => item !== "13") : [...prev, "13"])}>
                                        <p className={`${workDay.includes("13") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T4</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("14") ? prev.filter(item => item !== "14") : [...prev, "14"])}>
                                        <p className={`${workDay.includes("14") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T5</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("15") ? prev.filter(item => item !== "15") : [...prev, "15"])}>
                                        <p className={`${workDay.includes("15") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T6</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("16") ? prev.filter(item => item !== "16") : [...prev, "16"])}>
                                        <p className={`${workDay.includes("16") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T7</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("10") ? prev.filter(item => item !== "10") : [...prev, "10"])}>
                                        <p className={`${workDay.includes("10") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>CN</p>
                                    </div>
                                </div>
                            </div>
                            <div className='flex flex-col gap-2 ml-8 mt-2'>
                                <p>Afternoon:</p>
                                <div className='flex gap-3'>
                                    <div onClick={() => setWorkDay(prev => prev.includes("21") ? prev.filter(item => item !== "21") : [...prev, "21"])}>
                                        <p className={`${workDay.includes("21") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T2</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("22") ? prev.filter(item => item !== "22") : [...prev, "22"])}>
                                        <p className={`${workDay.includes("22") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T3</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("23") ? prev.filter(item => item !== "23") : [...prev, "23"])}>
                                        <p className={`${workDay.includes("23") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T4</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("24") ? prev.filter(item => item !== "24") : [...prev, "24"])}>
                                        <p className={`${workDay.includes("24") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T5</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("25") ? prev.filter(item => item !== "25") : [...prev, "25"])}>
                                        <p className={`${workDay.includes("25") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T6</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("26") ? prev.filter(item => item !== "26") : [...prev, "26"])}>
                                        <p className={`${workDay.includes("26") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>T7</p>
                                    </div>
                                    <div onClick={() => setWorkDay(prev => prev.includes("20") ? prev.filter(item => item !== "20") : [...prev, "20"])}>
                                        <p className={`${workDay.includes("20") ? "bg-gray-800 text-gray-200" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>CN</p>
                                    </div>
                                </div>
                            </div>
                        </div> */}
            ...
            {/* Doctor list here */}
            <p className='mb-2'>All Doctor List</p>
